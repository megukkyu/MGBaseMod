...
public class RegisterRecipes {
	...
	private static void registerSmeltingRecipes(FMLInitializationEvent event) {
		...
		FurnaceRecipes.instance().addSmeltingRecipeForBlock(MGBaseMod.BLOCKS.block_lead_ore, new ItemStack(MGBaseMod.ITEMS.item_lead_ingot), 0.6F);
		FurnaceRecipes.instance().addSmeltingRecipeForBlock(MGBaseMod.BLOCKS.block_tin_ore, new ItemStack(MGBaseMod.ITEMS.item_tin_ingot), 0.6F);
